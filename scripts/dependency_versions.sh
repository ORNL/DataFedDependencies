...
DATAFED_LIBSODIUM_VERSION="1.0.21"
...
DATAFED_LIBCURL="8.19.0"
DATAFED_LIBCURL_URL="https://github.com/curl/curl/releases/download/curl-8_19_0/curl-8.19.0.tar.gz"
DATAFED_OPENSSL="3.2.6"
DATAFED_OPENSSL_COMMIT="86874e2"
DATAFED_BOOST="1.74.0"
DATAFED_ZLIB_VERSION="1.3.2"
DATAFED_ZLIB_URL="https://zlib.net/zlib-1.3.2.tar.gz"
DATAFED_GCS_SUBMODULE_VERSION="ff7167860345e9b994110dfabdb251fe4dea8c00"
DATAFED_PYTHON_GLOBUS_SDK_VERSION=3.41.0
DATAFED_PYTHON_GLOBUS_CLI_VERSION=3.28.2
